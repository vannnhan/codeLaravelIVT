...
<!--<![endif]-->
    <table class="wrapper" cellpadding="0" cellspacing="0" role="presentation"><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" align="center" style="Margin-top:6px;Margin-bottom:20px;">
            <div align="left" id="emb-email-header" class="logo-left"><img src="{{$message->embed('images/logo.png')}}" alt="" width="283" style="max-width:283px"></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
      ...
      <div class="layout one-col fixed-width layout--inherit-padding--inline">
        <div class="layout__inner" style="background-color: #fff;">
      ...
      <div class="text--inline">
        <h1 class="size-14" style="font-family: sans-serif; font-size: 14px; line-height: 21px;" lang="x-size-14">
            <span class="font-sans-serif">
                <span style="color:#6e6c6e">
                    Kính chào quý công ty <b>{{$name_company}}</b><br>
                    Hợp đồng <b>#{{$code}}</b> vừa được khởi tạo trên hệ thống của công ty TNHH TM-DV Vạn Liên Hoa
                </span>
            </span>
        </h1>
        Thông tin hợp đồng của quý khách như sau:<br/>
        Tên hợp đồng: <b>{{$name_contract}}</b><br/>
        Mã hợp đồng <b>#{{$code}}</b><br/>
        Giá trị: <b>{{number_format($value).' VNĐ'}}</b><br/>
        Ngày bắt đầu: <b>{{$begin}}</b><br/>
        Ngày kết thúc: <b>{{$end}}</b><br/>
        @if(isset($assign_name) || isset($assign_phone) || isset($assign_email))
        <p>--------------------------------------------------</p>
        <p>
            Thông tin nhân viên chăm sóc khách hàng khi quý khách hàng cần liên hệ : <br/>
            Nhân viên chăm sóc : <b>{{$assign_name}}</b><br/>
            Số điện thoại : <b>{{$assign_phone}}</b><br/>
            Email : <b>{{$assign_email}}</b>
        </p>
        <p>--------------------------------------------------</p>
        @endif
      </div>
        ...
        <div class="layout sidebar--inline email-footer">
          ...
          <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
            <div class="column wide">
              <div class="column__padding--inline">
                <table class="email-footer__links emb-web-links" role="presentation"><tr role="navigation">
                <td style="width: 26px;" class="emb-web-links"><a href="https://www.facebook.com/vanlienhoaco"><img src="{{$message->embed('images/facebook.png')}}" width="26" height="26" alt="Facebook"></a></td><td style="width: 26px;" class="emb-web-links"><a href="https://www.vanlienhoa.com"><img src="{{$message->embed('images/website.png')}}" width="26" height="26" alt="Website"></a></td>
                </tr></table>
                <div class="email-footer__address--inline">
                  <div>C&ocirc;ng ty TNHH Thương Mại Dịch Vụ Vạn Li&ecirc;n Hoa<br>Địa chỉ :&nbsp;Thửa đất 61, tờ bản đồ 32, tổ 13, Khu Phố 2, Phường Mỹ Phước, Thị X&atilde; Bến C&aacute;t, tỉnh B&igrave;nh Dương.<br>MST: 3702109839 &nbsp; &nbsp; &nbsp;<br>Điện thoại: 0274 3.595055/128/138 &nbsp; &nbsp;<br>Fax: 0274 3.595.568</div>
                </div>
            ...
            <div class="column narrow">
              <div class="column__padding--inline">
                <div class="footer__share-button">
                  <div class="footer__share-button__container--inline">
                    <fblike class="footer__share-button__link--inline">
                      &nbsp;<img src="{{$message->embed('images/fblike-icon@2x.png')}}" width="16" height="16" border="0" alt="" />
                      <span style="mso-text-raise: 3px;">Like&nbsp;</span>
                    </fblike>
                  </div>
  ...
  <script type="text/javascript" src="https://js.createsend1.com/js/jquery-1.7.2.min.js?h=C99A4659201803210443"></script><script type="text/javascript">$(function(){$('area,a').attr('target', '_blank');});</script></body>
</html>
