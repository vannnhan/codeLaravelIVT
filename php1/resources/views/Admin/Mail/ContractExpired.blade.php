...
<!--<![endif]-->
    <table class="wrapper" cellpadding="0" cellspacing="0" role="presentation"><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" align="center" style="Margin-top:0px;Margin-bottom:0px;">
            <div align="center" id="emb-email-header" class="logo-center"><a href="https://www.vanlienhoa.com"><img src="{{$message->embed('images/hed.jpg')}}" alt="Công ty Môi trường Vạn Liên Hoa" width="560" style="max-width:560px"></a></div>
          </div>
          ...
          <div class="column">
            ...
            <div class="column__padding--inline">
                <div class="text--inline">
                    <p>
                        Kính gửi quý công ty <b>{{$company_name}}</b>.<br/>
                        Dear <b>{{$customer_name}}</b>! <br/>
                        Công ty TNHH TM-DV Vạn Liên Hoa xin thông báo đến quý khách hàng thông tin hợp đồng <b>{{$contract_name}}</b> như sau: <br/>
                           Tên Hợp đồng        : <b>{{$contract_name}}</b> <br/>
                           Mã hợp đồng         : <b>{{$contract_code}}</b> <br/>
                           Sẽ hết hạn vào ngày : <b>{{$contract_end}}</b> <br/>
                    </p>
                    @if(isset($assign_name) || isset($assign_phone) || isset($assign_email) )
                    <p>
                        Quý khách cần tư vấn rõ hơn có thể liên hệ nhân viên chăm sóc khách hàng : <br/>
                        Nhân viên chăm sóc : <b>{{$assign_name}}</b><br/>
                        Số điện thoại : <b>{{$assign_phone}}</b><br/>
                        Email : <b>{{$assign_email}}</b><br/>
                    </p>
                    @endif
                    <p>
                        {{$form}}
        ...
        <div role="contentinfo">
            ...
            <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
                ...
                <div class="column__padding--inline">
                    ...
                    <div>C&ocirc;ng ty TNHH Thương Mại Dịch Vụ Vạn Li&ecirc;n Hoa<br>&nbsp;</div>
                    </div>
                    <div class="email-footer__permission--inline">
                    <div>Địa chỉ :&nbsp;Thửa đất 61, tờ bản đồ 32, tổ 13, Khu Phố 2, Phường Mỹ Phước, Thị X&atilde; Bến C&aacute;t, tỉnh B&igrave;nh Dương.<br>MST: 3702109839 &nbsp; &nbsp; &nbsp;<br>Điện thoại: 0274 3.595055/128/138 &nbsp; &nbsp;<br>Fax: 0274 3.595.568</div>
                    </div>
                    <!--[if mso]>&nbsp;<![endif]-->
                </div>
                </div>
            <!--[if (mso)|(IE)]></td><td style="width: 200px;" valign="top" class="w160"><![endif]-->
                ...
                <div class="column__padding--inline">
                    ...
                    <div class="footer__share-button__container--inline">
                        <fblike class="footer__share-button__link--inline" likeurl="https://www.facebook.com/VanLienHoaCo/">
                    ...
                    <div class="footer__share-button__container--inline">
                        <forwardtoafriend class="footer__share-button__link--inline" lang="vi-VN">
                        &nbsp;<img src="{{$message->embed('images/forward-icon@2x.png')}}" width="16" height="16" border="0" alt="" />
                        <span style="mso-text-raise: 3px;">Chuyển tiếp</span>
                        </forwardtoafriend>
                    </div>
                    </div>
                </div>
  ...
  <script type="text/javascript">$(function(){$('area,a').attr('target', '_blank');});</script></body>
</html>
