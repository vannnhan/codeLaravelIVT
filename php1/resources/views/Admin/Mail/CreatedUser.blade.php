      ...
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" align="center" style="Margin-top:6px;Margin-bottom:20px;">
            <div align="left" id="emb-email-header" class="logo-left"><img src="{{asset('https://i1.createsend1.com/ti/j/42/3A6/BB9/eblogo/logo.png')}}" alt="" width="283" style="max-width:283px"></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
        ...
        <h1 class="size-14" style="font-family: sans-serif; font-size: 14px; line-height: 21px;" lang="x-size-14">
            <span class="font-sans-serif">
                <span style="color:#6e6c6e">
                    Chào mừng nhân viên đến với hệ thống quản lý khách hàng công ty TNHH TM-DV Vạn Liên Hoa
                </span>
            </span>
        </h1>
        <p>Chào mừng {{$name}} đến với hệ thống quản lý, dưới đây là thông tin đăng nhập của bạn</p>
        <p>Email: {{$email}}</p>
        <p>Mật Khẩu: {{$pass}}</p>
      </div>
    </div>
          ...
          <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
            <div class="column wide">
              <div class="column__padding--inline">
                ...
                <td style="width: 26px;" class="emb-web-links"><a href="https://www.facebook.com/vanlienhoaco"><img src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" alt="Facebook"></a></td><td style="width: 26px;" class="emb-web-links"><a href="https://www.vanlienhoa.com"><img src="https://i7.createsend1.com/static/eb/master/13-the-blueprint-3/images/website.png" width="26" height="26" alt="Website"></a></td>
                </tr></table>
                ...
                <div class="footer__share-button">
                  <div class="footer__share-button__container--inline">
                    <fblike class="footer__share-button__link--inline">
                      &nbsp;<img src="https://i9.createsend1.com/static/eb/master/13-the-blueprint-3/images/fblike-icon@2x.png" width="16" height="16" border="0" alt="" />
